Given(/^there are some sites(?: with scores)?$/) do
  @sites = [
    create(:site, :with_centroid, total_score: -19, green_brown: 'green', address: 'Green site'),
    create(:site, :with_centroid, total_score: 0, green_brown: 'mix', address: 'Mixed site'),
